...
import 'package:management_app/screens/activity_actors/activity_database.dart';
import 'package:management_app/screens/home/components/side_menu_proj.dart';

import 'components/side_menu_activity_db.dart';


class ActivityDBMainScreen extends StatelessWidget {
          ...
          children: [
            ...
            if (Responsive.isDesktop(context))
              Expanded(
                ...
                child: SideMenuActivityDB(),
              ),
            Expanded(
              // It takes 5/6 part of the screen
              flex: 5,
              child: ActivityDatabaseScreen(),
            ),
          ],
        ),
      ),

...
import 'package:management_app/screens/activity_actors/indicators.dart';
import 'package:management_app/screens/home/components/side_menu_proj.dart';

import 'components/side_menu_indicator.dart';


class IndicatorMainScreen extends StatelessWidget {
          ...
          children: [
            ...
            if (Responsive.isDesktop(context))
              Expanded(
                ...
                child: SideMenuIndicator(),
              ),
            Expanded(
              // It takes 5/6 part of the screen
              flex: 5,
              child: IndicatorsScreen(),
            ),
          ],
        ),
      ),

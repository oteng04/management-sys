...
import 'package:management_app/screens/activity_actors/project_data.dart';
import 'package:management_app/screens/home/components/side_menu_proj.dart';

import 'components/side_menu_proj_data.dart';


class ProjDataMainScreen extends StatelessWidget {
          ...
          children: [
            ...
            if (Responsive.isDesktop(context))
              Expanded(
                ...
                child: SideMenuProjData(),
              ),
            Expanded(
              // It takes 5/6 part of the screen
              flex: 5,
              child: ProjectDataScreen(),
            ),
          ],
        ),
      ),
